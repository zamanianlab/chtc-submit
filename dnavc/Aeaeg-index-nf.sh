...
git clone https://github.com/zamanianlab/DNAseq-index-nf.git

# run nextflow (QC, star)
export NXF_OPTS='-Xms1g -Xmx8g'
nextflow run DNAseq-VC-nf/Aeaeg-index.nf -w work -c DNAseq-VC-nf/chtc.config --dir $1
...
mv output/$1.tar /staging/groups/zamanian_group/input/
