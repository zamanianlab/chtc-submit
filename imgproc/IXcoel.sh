...
Rscript Core_imgproc/CP/scripts/generate_filelist_coel.R $1

# run script
cellprofiler -c -r -p Core_imgproc/CP/pipelines/coel.cppipe --data-file=Core_imgproc/CP/metadata/image_paths_coel.csv

# join metatdata, tar output folder, and delete it
mv metadata output
Rscript Core_imgproc/CP/scripts/metadata_join_coel.R $1
